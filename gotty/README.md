...
### This project is used in [https://github.com/KubeOperator/webkubectl](https://github.com/KubeOperator/webkubectl/blob/master/Dockerfile#L8)  to run a JavaScript based terminal on web browsers
